...
(* OASIS_START *)
(* DO NOT EDIT (digest: f79df468b59b106eb7cc3a3b2355069a) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          maintainers = [];
          authors =
            ["Anil Madhavapeddy"; "Mindy Preston"; "Thomas Gazagnaire"];
          homepage = None;
          synopsis = "Buffered channels over Mirage FLOW implementations";
          description = None;
          categories = [];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "n\132Ôóæ\159E­CNX\005\012æ\154t";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
